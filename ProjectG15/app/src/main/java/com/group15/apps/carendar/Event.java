...
public class Event {
   ...
   // @Expose @SerializedName("dayOfMonth")
    private String mDayOfMonth = "dayOfMonth";
   // @Expose @SerializedName("startTime")
    private String mStartTime = "startTime";
   // @Expose @SerializedName("endTime")
    private String mEndTime = "endTime";
   // @Expose @SerializedName("color")
    ...
    public int getDayOfMonth() {
        return Integer.parseInt(mDayOfMonth);
    }

    public void setDayOfMonth(int dayOfMonth) {
        this.mDayOfMonth = Integer.toString(dayOfMonth);
    }
